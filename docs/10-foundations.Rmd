...
decision-making process \@draper1995.
...
```{stan, output.var = "simple_poisson_comp"}
data {
...
# The command to compile the model has been commented given that
# markdown automatically calls Stan once a Stan program is inserted
# into a chunk. So the model has been already compiled.
