...
```{stan, output.var = "simple_poisson_gen_quant_comp"}
...
```{stan, output.var = "multi_poisson_dgp_comp"}
...
```{stan, output.var = "multi_poisson_comp"}
/* Multi Poisson model*/
...
data {
  ...
  vector<lower = 0, upper = 1> live_in_super; // level of the apartment
}
...
We can write the negative binomial function in Stan as 
...
\@hoffman_gelman_2014 and Betancourt (2018)-. Here is a very nice
